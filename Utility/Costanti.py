...
nomiFiltriEsterniToIterni_dict = {
    ...
    "Per porta" : NOME_INTERNO_FILTRO_PORTA,
...
PROPORZIONI_PORTA_DISPOSITIVO_FRAMEDISPOSITIVO = round(7/100,2)
PROPORZIONI_TAG_TABELLA_DISPOSITIVI = round(26/100, 2)
PROPORZIONI_TEMPOPING_DISPOSITIVO_FRAMEDISPOSITIVO = round(7/100,2)
