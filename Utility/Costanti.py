...
PATH_IMG_ICONA_IMPOSTAZIONI = os.path.join(PATH_IMMAGINI, "ImmagineImpostazioni.png")
PATH_IMG_ICONA_DASHBOARD = os.path.join(PATH_IMMAGINI, "ImmagineDashboard.png")
PATH_IMG_ICONA_CATEGORIE = os.path.join(PATH_IMMAGINI, "ImmagineTag.png")
...
NOME_INTERNO_FILTRO_CATEGORIA = "filtroCategoriaAlfabetica"
NOME_INTERNO_FILTRO_HOST = "filtroHost"
NOME_INTERNO_FILTRO_PORTA = "filtroPerPorta"
NOME_INTERNO_FILTRO_STABILITA = "filtroPerStabilita"

nomiFiltriEsterniToIterni_dict = {
    "Per inserimento" : NOME_INTERNO_FILTRO_NOFILTRI,
    "Per nome" : NOME_INTERNO_FILTRO_NOME,
    "Per categoria (alfabetica)" : NOME_INTERNO_FILTRO_CATEGORIA,
    "Per ip" : NOME_INTERNO_FILTRO_HOST,
    "Per status" : NOME_INTERNO_FILTRO_STATUSOFFON
}
...
PROPORZIONI_NOME_DISPOSITIVO_FRAMEDISPOSITIVO = round(22/100,2)
PROPORZIONI_INDIRIZZO_DISPOSITIVO_FRAMEDISPOSITIVO = round(22/100,2)
PROPORZIONI_PORTA_DISPOSITIVO_FRAMEDISPOSITIVO = round(8/100,2)
PROPORZIONI_TAG_TABELLA_DISPOSITIVI = round(18/100, 2)
PROPORZIONI_TEMPOPING_DISPOSITIVO_FRAMEDISPOSITIVO = round(22/100,2)
PROPORZIONI_TASTI_MODDEL_TABELLA_DISPOSITIVI = round(8/100, 2)
...
TUPLA_PAGINA_IMPOSTAZIONI = (NOME_INTERNO_PAGINA_IMPOSTAZIONI, PATH_IMG_ICONA_IMPOSTAZIONI, "Impostazioni")
LISTA_PAGINE_MENU = [
    #("nomePaginaInterno", "pathImmagine", "nomePaginaMostrato") 
    (NOME_INTERNO_PAGINA_DISPOSITIVI,PATH_IMG_ICONA_DISPOSITIVO, "Dispositivi"),
    (NOME_INTERNO_PAGINA_DASHBOARD, PATH_IMG_ICONA_DASHBOARD, "Dashboard"),
    (NOME_INTERNO_PAGINA_CATEGORIE, PATH_IMG_ICONA_CATEGORIE, "Tag")
]
